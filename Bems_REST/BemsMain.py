...
# AHU Now Data 조회
@app.get("/GetAhuNowTempData")
async def GetAhuNowTempData(runDate: str):
    result = await BemsService.GetAhuNowTempData(runDate)
    return Response(content=result, media_type="application/json")
...
async def GetChillerCwstData(runDate: str):
    result = await BemsService.GetChillerCwstData(runDate)
    return Response(content=result, media_type="application/json")
...
# Boiler Total Data 조회
@app.get("/GetBoilerTotalData")
async def GetBoilerTotalData(runDate: str):
    result = await BemsService.GetBoilerTotalData(runDate)
    return Response(content=result, media_type="application/json")
